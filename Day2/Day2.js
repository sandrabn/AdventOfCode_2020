var input = ['13-17 s: ssssssssssssgsssj',
'7-9 p: pnlzhcppvl',
'5-6 z: zzbwrv',
...
//Puzzle part 1
countCorrectPasswordsWithRegex(input)
console.log(input.length)


//Puzzle part 2
countCorrectPasswordsWithPositioning(input)

function countCorrectPasswordsWithRegex(input){
    var countTotal = 0
    for (var i = 0; i < input.length; i++){

        var matcher = input[i].substring(0, input[i].indexOf(":"))
        var password = input[i].substring(input[i].indexOf(":") + 1)
        var min = matcher.substring(0, matcher.indexOf("-"))
        var max = matcher.substring(matcher.indexOf("-") + 1, matcher.indexOf(" "))
        var symbol = matcher.substring(matcher.indexOf(" ") + 1)
        ...
        if(password.includes(symbol)){
            ...
            // console.log(regex)
            // console.log('Found this many occurences of symbol: ' + count)
...
function countCorrectPasswordsWithPositioning(input){
    var countTotal = 0
    for (var i = 0; i < input.length; i++){

        var matcher = input[i].substring(0, input[i].indexOf(":"))
        var password = input[i].substring(input[i].indexOf(":") + 1)
        var firstPosition = matcher.substring(0, matcher.indexOf("-"))
        var secondPosition = matcher.substring(matcher.indexOf("-") + 1, matcher.indexOf(" "))
        var character = matcher.substring(matcher.indexOf(" ") + 1)
        // console.log('matcher: \'' + matcher + '\'')
        // console.log('password: \'' + password + '\'')
        // console.log('min: \'' + firstPosition + '\'')
        // console.log('max: \'' + secondPosition + '\'')
        // console.log('symbol: \'' + character  + '\'')
        // console.log('first position: ' + password[Number(firstPosition)])
        // console.log('second position: ' + password[Number(secondPosition)])
        if(password.includes(character)){
            if (password[Number(firstPosition)] === character && !(password[Number(secondPosition)] === character)){
                //console.log('found a match!')
                countTotal++
            } else if (password[Number(secondPosition)] === character && !(password[Number(firstPosition)] === character)){
                //console.log('found a match!')
                countTotal++
            }
